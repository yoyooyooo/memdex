...
```text
codebase-retrieve/scripts/codebase-retrieve.py
codebase-retrieve/tests/test_codebase_retrieve_cli.py
codebase-retrieve/SKILL.md
codebase-retrieve/references/workflow.md
```
