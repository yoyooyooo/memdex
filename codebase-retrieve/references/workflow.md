...
python3 ./codebase-retrieve/scripts/codebase-retrieve.py init --repo . --notebook-id <id>
```
...
```bash
python3 ./codebase-retrieve/scripts/codebase-retrieve.py temp-source upload --repo . \
...
```bash
python3 ./codebase-retrieve/scripts/codebase-retrieve.py ask --repo . \
...
```bash
python3 ./codebase-retrieve/scripts/codebase-retrieve.py locate --repo . \
