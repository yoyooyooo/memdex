...
```bash
python3 ./codebase-retrieve/scripts/codebase-retrieve.py init --repo . --create-notebook
python3 ./codebase-retrieve/scripts/codebase-retrieve.py ask --repo . "Where is reconnect/backfill implemented?"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py locate --repo . "invoice export retry command"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py pack --repo . --dry-run
```
...
```bash
python3 ./codebase-retrieve/scripts/codebase-retrieve.py init --repo .
python3 ./codebase-retrieve/scripts/codebase-retrieve.py init --repo . --create-notebook
python3 ./codebase-retrieve/scripts/codebase-retrieve.py init --repo . --reuse-existing-notebook
python3 ./codebase-retrieve/scripts/codebase-retrieve.py ask --repo . "question"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py ask --repo . --yes "question"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py ask --repo . --verbose "question"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py ask --repo . --json "question"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py locate --repo . "thing to find"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py locate --repo . --verbose "thing to find"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py locate --repo . --json "thing to find"
python3 ./codebase-retrieve/scripts/codebase-retrieve.py pack --repo . --dry-run
python3 ./codebase-retrieve/scripts/codebase-retrieve.py pack --repo . --dry-run --json
python3 ./codebase-retrieve/scripts/codebase-retrieve.py pack --repo . --dry-run --include-files --json
python3 ./codebase-retrieve/scripts/codebase-retrieve.py temp-source upload --repo . --kind notes --title retry-design --file /tmp/source.md
python3 ./codebase-retrieve/scripts/codebase-retrieve.py temp-source list --repo .
python3 ./codebase-retrieve/scripts/codebase-retrieve.py temp-source cleanup --repo . --kind notes --yes
python3 ./codebase-retrieve/scripts/codebase-retrieve.py status --repo .
python3 ./codebase-retrieve/scripts/codebase-retrieve.py ensure --repo . --yes
python3 ./codebase-retrieve/scripts/codebase-retrieve.py refresh --repo . --force
```
